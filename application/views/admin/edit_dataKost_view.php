...
<html lang="en">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <?php echo form_open_multipart('dataKost/updateData/'.$this->uri->segment(3)); ?>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="alamat" id="alamat" value="<?php echo $kost[0]->alamat ?>">
    </div>
    <div class="form-group">
      <label for="">Lade</label>
      <input type="text" class="form-control" name="latitude" id="latitude" value="<?php echo $kost[0]->latitude ?>">
    </div>
     <div class="form-group">
      <label for="">Lode</label>
      <input type="text" class="form-control" name="longitude" id="longitude" value="<?php echo $kost[0]->longitude ?>">
    </div>
     <div class="form-group">
      <label for="">Tersedia</label>
      <input type="text" class="form-control" name="tersedia" id="tersedia" value="<?php echo $kost[0]->tersedia ?>">
    </div>
     <div class="form-group">
      <label for="">Status</label>
      <input type="text" class="form-control" name="status" id="status" value="<?php echo $kost[0]->status ?>">
    </div>
     <div class="form-group">
