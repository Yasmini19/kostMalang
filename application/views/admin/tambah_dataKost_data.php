  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Pemilik Kost</p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item active" href="<?php echo base_url('index.php/DataKost/')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Kost</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Pemilik</span><i class="treeview-indicator fa fa-angle-right"></i></a>
   ...
   <div class="jumbotron shadow p-3 mb-5 bg-white rounded">
      ...
      <?php 
        ...
        echo "";
        echo '<br>'.anchor('DataKost', 'Masukkan Data Lagi'); 
      ?>
     </div>
   </div>
